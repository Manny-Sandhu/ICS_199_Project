        ...
        while ($row = mysqli_fetch_array ($result)) {
			...
			if ($isDisabled == 'Y') { // When item is disabled, display "Enable" button
				...
				echo "<div class=\"row my-1 border-bottom\">
						...
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_edit\" name=\"{$row['item_name']}\" value=\"{$row['item_desc']}, {$row['item_price']}\" type='button' class='btn btn-primary edit px-2 px-md-4'>Edit</button></div>
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_delete\" name=\"{$row['item_name']}\" type='button' class='btn btn-primary delete px-2 px-md-4'>Del</button></div>
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_enable\" name=\"{$row['item_name']}\" type='button' class='btn btn-primary enable px-2 px-md-4'>Ena</button></div>
					</div>";
				...
				echo "<div class=\"row my-1 border-bottom\">
						...
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_edit\" name=\"{$row['item_name']}\" value=\"{$row['item_desc']}#{$row['item_price']}\" type='button' class='btn btn-primary edit px-2 px-md-4'>Edit</button></div>
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_delete\" name=\"{$row['item_name']}\" type='button' class='btn btn-primary delete px-2 px-md-4'>Del</button></div>
						<div class=\"col-2 col-md-1 text-center\"> <button id=\"{$row['item_id']}_disable\" name=\"{$row['item_name']}\" type='button' class='btn btn-primary disable px-2 px-md-4'>Dis</button></div>
					</div>";
